...
public class Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //added
        shStudents =(Button) findViewById(R.id.show_students);
        ...
        //added
        shStudents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Admin.this , ShowStudents.class));
            }
        });
    ...
    private void updateToFireStore(String id , String title , String desc){
        ...
        db.collection("Cours").document(id).update("title" , title , "desc" , desc)
    ...
    private void saveToFireStore(String id , String title , String desc){
        ...
        if (!title.isEmpty() && !desc.isEmpty()){
            ...
            db.collection("Cours").document(id).set(map)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
